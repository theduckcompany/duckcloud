...
type FSMVTaskRunner struct {
	inodes  inodes.Service
	folders folders.Service
}

func NewFSMVTaskRunner(inodes inodes.Service, folders folders.Service) *FSMVTaskRunner {
	return &FSMVTaskRunner{inodes, folders}
}

func (r *FSMVTaskRunner) Name() string { return "fs-mv" }

func (r *FSMVTaskRunner) RunArgs(ctx context.Context, args *scheduler.FSMoveArgs) error {
